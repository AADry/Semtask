...
public class DeleteFrame extends javax.swing.JFrame {
        List<IShape> container2 = new ArrayList<>();
        DefaultComboBoxModel<String> cbmodel2;
    /**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        MainFrame mainframe = new MainFrame();
            mainframe.shapes.addAll(container2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        container2.remove(jComboBox1.getSelectedIndex());
         MainFrame mainframe = new MainFrame();
            mainframe.shapes.addAll(container2);
            mainframe.setVisible(true);
            this.dispose();
